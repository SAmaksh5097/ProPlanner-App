  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-5 py-2">
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-brand-muted/20 dark:border-brand-muted/10 flex flex-col items-center justify-center text-center">
